...
const conversationPage: NextPage<Props> = ({}) => {
  ...
  return (
    <div>
      ...
      <Heading
        title="Conversation"
        description="Our advance conversation model."
        icon={MessagesSquare}
      ...
      <div className="px-4 lg:px-8">
        <Form {...form}>
          <form
            ...
            className="rounded-lg border-lg border w-full p-4 px-3 md:px-6 focus-within:shadow-sm grid grid-cols-12 gap-2"
          >
            <FormField
              name="prompt"
              render={({ field }) => (
